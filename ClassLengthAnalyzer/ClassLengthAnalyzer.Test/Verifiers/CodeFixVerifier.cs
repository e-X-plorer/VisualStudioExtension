...
namespace TestHelper
{
    ...
    public abstract partial class CodeFixVerifier : DiagnosticVerifier
    {
        ...
        protected void VerifyCSharpCreatedFix(string oldSource, params string[] newSource)
        {
            VerifyCreatedFix(LanguageNames.CSharp, GetCSharpDiagnosticAnalyzer(), GetCSharpCodeFixProvider(), oldSource, newSource, null, false);
        }
...
//            document.Project.Solution.Get
//            document.Project.Solution.
//            NewDocument document.Project.Solution.GetDo
